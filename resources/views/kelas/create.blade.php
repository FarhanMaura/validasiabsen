    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Buat kelas baru untuk mengelompokkan siswa</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-emerald-50">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Form Kelas Baru</h3>
                            <p class="text-sm text-gray-600">Lengkapi informasi kelas di bawah ini</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    <label class="relative">
                                        <input type="radio" name="tingkat" value="10" class="hidden peer" {{ old('tingkat') == '10' ? 'checked' : '' }} required>
                                    ...
                                    <label class="relative">
                                        <input type="radio" name="tingkat" value="11" class="hidden peer" {{ old('tingkat') == '11' ? 'checked' : '' }}>
                                    ...
                                    <label class="relative">
                                        <input type="radio" name="tingkat" value="12" class="hidden peer" {{ old('tingkat') == '12' ? 'checked' : '' }}>
                        ...
                        <div class="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                                    <span class="text-green-600 font-bold" id="previewTingkat">-</span>
                                </div>
                                <div>
                                    <p class="text-sm font-semibold text-gray-900" id="previewNama">Nama Kelas</p>
                                    <p class="text-xs text-gray-600" id="previewJurusan">Jurusan</p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                ...
                const jurusan = jurusanInput.value || 'Jurusan';
                const namaKelas = namaKelasInput.value || 'Nama Kelas';
